...
public class KeyHandler
{
    ...
    private bool CursorIsAtStartOfBuffer() => _console.CursorLeft == 0;

    private bool CursorIsAtEndOfBuffer() => _console.CursorLeft == _console.BufferWidth;
    ...
    private void WriteCharacter() => WriteCharacter(_keyInfo.KeyChar);
